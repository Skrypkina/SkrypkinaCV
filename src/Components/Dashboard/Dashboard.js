  ...
  <div className={styles.menu}>
    <ul className={styles.menuContainer}>
      <li className={styles.menuContent}>
        ...
        <h6 className={styles.menuDescr}>Who I Am</h6>
      </li>
      <li className={styles.menuContent}>
        <NavLink
          to="/projects"
          ...
          className={styles.menuLink}
        >
          <h3 className={styles.menuTitle}>Projects</h3>
        </NavLink>
        <svg
          className={styles.svg}
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h6 className={styles.menuDescr}>My Projects</h6>
      </li>
      <li className={styles.menuContent}>
        ...
        >
          <path
            d="M1.758,2.944c0.002,0,3.081-0.771,5.741-0.771c2.659,0,5.74,0.771,5.743,0.771c1.134,0.261,1.84,1.392,1.578,2.525
        ...
        <h6 className={styles.menuDescr}>Let's get in touch</h6>
      </li>
    </ul>
  </div>
);
